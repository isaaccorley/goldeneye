...
2. [x] Add `load_rs5m` - Implemented ✅
3. [ ] Add `load_levir_cc` - Change captioning (unique task)
4. [ ] Add `load_teochatlas` - Temporal EO (125GB, complex loader)
5. [ ] Investigate FloodNet VQA - Disaster domain (gated)
