...
from geovllm.models.earthdial.internvl_model.conversation import get_conv_template
from geovllm.models.earthdial.internvl_model.internlm2.modeling_internlm2 import (
    InternLM2ForCausalLM,
)
from geovllm.models.earthdial.internvl_model.phi3.modeling_phi3 import Phi3ForCausalLM
...
class InternVLChatModel(PreTrainedModel):
    ...
    def forward(
        ...
        statistics: torch.LongTensor | None = None,
        loss_weight: list | None = None,
        loss_reduction_all_gather: bool | None = False,
